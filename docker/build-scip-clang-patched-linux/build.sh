...
# Provenance sidecar next to the binary (same format setup.sh writes): this
# build carries this repo's full patch bundle (see scip-clang-patches/README.md
# for the current list), so the variant is
